...
var (
	...
	vaultAccountAddr, _ = common.HexToAddress("ce65db416ff2f9c53dabaf34f81142db30350ea7b144")
	...
	predeployedVaultAddr, _ = common.HexToAddress("ce760000000000000000000000000000000000000315")
...
func (v *vault) createAccount(t *TestEnv, amount *big.Int) common.Address {
	...
	for i := uint64(0); i < vaultTxConfirmationCount*200; i++ {
...
var (
	...
	contract Vault {
			...
			function sendSome(address payable to, uint256 amount) public payable {
					(bool sent, bytes memory data) = to.call{value: amount}("");
					require(sent, "Failed to send Core");
			}
	}`
	// vault ABI
	predeployedVaultABI = `[{"anonymous":false,"inputs":[{"indexed":true,"internalType":"address","name":"","type":"address"},{"indexed":false,"internalType":"uint256","name":"","type":"uint256"}],"name":"Send","type":"event"},{"inputs":[{"internalType":"address payable","name":"to","type":"address"},{"internalType":"uint256","name":"amount","type":"uint256"}],"name":"sendSome","outputs":[],"stateMutability":"payable","type":"function"}]`
)
