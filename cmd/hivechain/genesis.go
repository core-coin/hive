...
const (
	blocktimeSec   = 7 // hard-coded in core.GenerateChain
	cliqueEpoch    = 30000
)

// var (
	// cliqueSignerKey  = knownAccounts[8].PrivateKey()
	// cliqueSignerAddr = knownAccounts[8].Address()
// )

// Core Blockchain mainnet forks in order of introduction.
// var (
...
func addEmitContract(ga core.GenesisAlloc) {
	addr, err := common.HexToAddress(emitAddr)
	if err != nil {
		panic(err)
	}
	ga[addr] = core.GenesisAccount{
